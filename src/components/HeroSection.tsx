      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-white/10 text-xs font-mono text-slate-300 shadow-md">
            ...
            <span className="text-chalk-cyan font-semibold">
              Provisional Patent Filed
            </span>
            <span className="text-slate-600">•</span>
            <span className="text-slate-200">App No. 202641089516</span>
            <span className="hidden sm:inline text-slate-600">•</span>
            <span className="hidden sm:inline text-chalk-emerald font-medium">
              TRL-2 → TRL-9 Pathway
            </span>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed font-sans">
            <strong className="text-white">Digi-Chalk</strong> is an
            edge-computed hardware retrofit that transforms standard blackboards
            into real-time interactive digital hubs for{" "}
            <strong className="text-chalk-emerald">₹45,000 per unit</strong>
            —bringing digital equity to the{" "}
            <span className="text-chalk-cyan font-medium">
              90% of classrooms
            </span>{" "}
            left behind by high-cost smartboards.
          </p>
